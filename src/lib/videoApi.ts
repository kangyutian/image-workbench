...
export interface VideoTask { id: string; kind: "video"; status: VideoStatus; results: Array<{ url: string }>; error: string; createdAt: string; input: { modelId: VideoModelId; prompt: string; referenceImages: Array<{ url: string; fileName?: string }>; motionVideo?: { url: string; fileName?: string }; duration?: number; aspectRatio?: string; resolution?: string; generateAudio?: boolean; characterOrientation?: "image" | "video"; keepOriginalSound?: boolean }; }
