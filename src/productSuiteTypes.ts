...
export type ProductSuiteHairColor = "natural" | "black" | "dark-brown" | "light-brown" | "blonde" | "copper-red" | "silver-gray";
export type ProductSuiteSkinTone = "natural" | "fair" | "medium" | "tan" | "deep";
export type ProductSuiteModelAppearance = "unspecified" | "white" | "black" | "east-asian" | "south-asian" | "southeast-asian" | "hispanic-latino" | "mena" | "indigenous" | "pacific-islander" | "mixed" | "custom";
...
export interface ProductSuite { id: string; status: ProductSuiteStatus; createdAt: string; updatedAt: string; modelReferenceAnalysisStatus?: ProductSuiteModelAnalysisStatus; input: { model: ProductSuiteModel; nanoModel: string; gender: ProductSuiteGender; bodyType: ProductSuiteBodyType; ageRange: ProductSuiteAgeRange; hairStyle: ProductSuiteHairStyle; hairColor: ProductSuiteHairColor; skinTone: ProductSuiteSkinTone; modelAppearance?: ProductSuiteModelAppearance; modelAppearanceCustom?: string; hasModelReference?: boolean; backgroundMode: "white" | "custom"; aspectRatio: "4:5"; resolution: "2k"; productName: string; sellingPoints: string; style?: string; prompts: Record<ProductSuiteSlot, string> }; items: ProductSuiteItem[]; recovery?: { canRecoverBackground: boolean }; }
export interface CreateProductSuiteInput { images: ProductSuiteMedia[]; backgroundImages?: ProductSuiteMedia[]; modelReferenceImage?: ProductSuiteMedia; model: ProductSuiteModel; gender: ProductSuiteGender; bodyType: ProductSuiteBodyType; ageRange: ProductSuiteAgeRange; hairStyle: ProductSuiteHairStyle; hairColor: ProductSuiteHairColor; skinTone: ProductSuiteSkinTone; modelAppearance: ProductSuiteModelAppearance; modelAppearanceCustom?: string; backgroundMode: "white" | "custom"; productName: string; sellingPoints: string; prompts: Partial<Record<ProductSuiteSlot, string>>; }
